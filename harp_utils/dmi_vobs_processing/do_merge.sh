...
DBASE_PATH=/ec/res4/scratch/nhd/verification/DMI_data/harp_v0201/OBSTABLE
...
#python3 merge_tables_dmi_mars_v021.py $DBASE_PATH $YEAR
echo "Merging DMI, MARS and IMO"
#python3 merge_tables_imo_dmi_mars.py $DBASE_PATH $YEAR
python3 merge_tables_imo_dmi_mars_v021.py $DBASE_PATH $YEAR
