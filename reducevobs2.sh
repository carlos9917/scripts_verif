...
hour_end=23
reduce=True #CHANGE. if True, will reduce the file size. If not only split the files
years=(2019) #(2017 2018)
month=(04 06) # 02 03 04 05 06 07 08 09 10 11 12)
vars=(PS RH TD) # Not active yet. ONLY needed by the conversion script, not to split the files
init_times=(00 06 12 18)
region=Greenland
WRKDIR=/data/cap/vobs_reduced/$region/
